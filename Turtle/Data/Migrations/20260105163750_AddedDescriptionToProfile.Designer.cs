...
namespace Turtle.Data.Migrations
{
    ...
    [Migration("20260105163750_AddedDescriptionToProfile")]
    partial class AddedDescriptionToProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turtle.Models.UserFollow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Turtle.Models.UserFollow", b =>
                {
                    b.HasOne("Turtle.Models.ApplicationUser", "Follower")
                        .WithMany("Following")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Turtle.Models.ApplicationUser", "Following")
                        .WithMany("Followers")
